...
export default class App extends Vue {
    ...
    get windowStyle() {
        ...
        return `height: ${heightValue}px; width: ${widthValue}px; transform: scale(${transformValue}); top: ${topValue}%; left: ${leftValue}%;`;
    }
    ...
    async runService() {
        const loop = () =>
            backend.run(this.$root.$data.config).catch(console.error);
